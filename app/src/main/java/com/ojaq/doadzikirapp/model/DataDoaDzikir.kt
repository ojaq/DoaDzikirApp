package com.ojaq.doadzikirapp.model
...
object DataDoaDzikir {
    object DataDoaDzikir {
        ...
        val listQouliyah: List<DoaDzikirItem>
            get() {
                val list = mutableListOf<DoaDzikirItem>()
                for (data in titleQauliyah.indices) {
                    val index = DoaDzikirItem(
                        titleQauliyah[data],
                        arabicQauliyah[data],
                        translateQauliyah[data]
                    )
                    list.add(index)
                }
                return list
        ...
        val listDzikir: ArrayList<DoaDzikirItem>
            get() {
        ...
        val listDzikirPagi: ArrayList<DoaDzikirItem>
            get() {

                val list = arrayListOf<DoaDzikirItem>()
                for (data in arabicDzikirPagi.indices) {
                    val dzikir = DoaDzikirItem(
                        titleDzikirPagi[data],
                        arabicDzikirPagi[data],
                        translateDzikirPagi[data]
                    )
                    list.add(dzikir)
                }
                return list
        ...
        val listDzikirPetang: ArrayList<DoaDzikirItem>
            get() {

                val list = arrayListOf<DoaDzikirItem>()
                for (data in arabicDzikirPetang.indices) {
                    val dzikir = DoaDzikirItem(
                        titleDzikirPetang[data],
                        arabicDzikirPetang[data],
                        translateDzikirPetang[data]
                    )
                    list.add(dzikir)
                }
                return list
